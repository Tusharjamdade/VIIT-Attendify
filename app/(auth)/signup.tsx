...
// import { EnvelopeIcon, LockClosedIcon, UserIcon, KeyIcon, IdentificationIcon } from 'react-native-heroicons/outline';
...
//       {/* Sign Up Button */}
//       <TouchableOpacity className="w-full h-12 bg-blue-500 rounded-lg items-center justify-center mb-6 shadow-md" onPress={handleSignUp}>
